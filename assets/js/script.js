...
function getForecast(cityName) {
    // Code for first API call which retrieves and displays weather data for current day
    ...
    // Code for alert message when invalid city is entered
    .catch(function(e) {
        alert("Please enter a valid city name!");
    });
    // Code for second API call which retrieves and displays weather data for next 5 consecutive days
    ...
    // Code to reset search input field
    $("#city-input").val("");
};
...
function displayHistory() {
    ...
    for (i = 0; i < cities.length; i++) {
        ...
        h5.classList.add("card", "search");
    };
    // Code for click event on search history cities
    searchHistory.addEventListener("click", populateHistory);
};

// Function to populate weather data based off city from search history
...
// Code to display search history on page load
displayHistory();